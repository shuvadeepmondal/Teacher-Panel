import {
  ...
  interface Product {
    ...
    day: string;
    roomno: string; 
    status: "Occupided" | "Pending" | "Not Occupided";
  }
  ...
  const tableData: Product[] = [
    ...
    },
    {
      ...
      timeslot: "4",
      status: "Not Occupided",
    },
  ];
  
  export default function Availableclass() {
    return (
          ...
          <Table>
            ...
            <TableHeader className="border-gray-100 dark:border-gray-800 border-y">
              <TableRow>
                ...
                <TableCell
                  isHeader
                  className="py-3 text-center font-medium text-gray-500 text-theme-xs dark:text-gray-400"
                >
                  Semester
                </TableCell>
                <TableCell
